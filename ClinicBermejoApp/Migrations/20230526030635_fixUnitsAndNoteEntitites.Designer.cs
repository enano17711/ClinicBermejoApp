...
namespace ClinicBermejoApp.Migrations
{
    ...
    [Migration("20230526030635_fixUnitsAndNoteEntitites")]
    partial class fixUnitsAndNoteEntitites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Orders.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Entities.Models.Orders.Order", b =>
                {
                    b.HasOne("Entities.Models.Orders.Note", "Note")
                        .WithMany("Orders")
