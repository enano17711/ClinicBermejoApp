...
namespace ClinicBermejoApp.Migrations
{
    ...
    [Migration("20230529152009_update_Unit_Item_relationship")]
    partial class update_Unit_Item_relationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemUnit", b =>
                {
                    b.HasOne("Entities.Models.Items.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.Items.Unit", null)
                        .WithMany()
